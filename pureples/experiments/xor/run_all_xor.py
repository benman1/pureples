...
thefile.write(
    ...
    str(es_hyperneat_medium_solved) +
    " out of " +
    str(runs) +
    " runs.")
...
plt.plot(
    range(gens),
    es_hyperneat_small_average_fit,
    'b-.',
    label="ES-HyperNEAT small")
plt.plot(
    range(gens),
    es_hyperneat_medium_average_fit,
    'c-.',
    label="ES-HyperNEAT medium")
plt.plot(
    range(gens),
    es_hyperneat_large_average_fit,
    'm-.',
