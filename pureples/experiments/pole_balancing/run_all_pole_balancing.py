...
def run(i):
    ...
    es_hyperneat_small_stats.append(
        es_hyperneat_pole_balancing_small.run(
            gens, env)[1])
    es_hyperneat_medium_stats.append(
        es_hyperneat_pole_balancing_medium.run(
            gens, env)[1])
    es_hyperneat_large_stats.append(
        es_hyperneat_pole_balancing_large.run(
            gens, env)[1])
...
thefile.write(
    ...
    str(es_hyperneat_small_one_solved) +
    " out of " +
    str(runs) +
    " runs.\n")
...
thefile.write(
    ...
    str(es_hyperneat_small_ten_solved) +
    " out of " +
    str(runs) +
    " runs.\n")
...
if max_fit in es_hyperneat_small_hundred_average_fit:
    ...
    thefile.write("ES-HyperNEAT small hundred does not solve pole_balancing with best fitness: " +
                  str(es_hyperneat_small_hundred_average_fit[gens - 1]))
thefile.write(
    "\nES-HyperNEAT small hundred solves pole_balancing in " +
    str(es_hyperneat_small_hundred_solved) +
    " out of " +
    str(runs) +
    " runs.\n")
...
thefile.write(
    ...
    str(es_hyperneat_medium_one_solved) +
    " out of " +
    str(runs) +
    " runs.\n")
...
thefile.write(
    ...
    str(es_hyperneat_medium_ten_solved) +
    " out of " +
    str(runs) +
    " runs.\n")
...
if max_fit in es_hyperneat_medium_hundred_average_fit:
    ...
    thefile.write("ES-HyperNEAT medium hundred does not solve pole_balancing with best fitness: " +
                  str(es_hyperneat_medium_hundred_average_fit[gens - 1]))
thefile.write(
    "\nES-HyperNEAT medium hundred solves pole_balancing in " +
    str(es_hyperneat_medium_hundred_solved) +
    " out of " +
    str(runs) +
    " runs.\n")
...
thefile.write(
    ...
    str(es_hyperneat_large_one_solved) +
    " out of " +
    str(runs) +
    " runs.\n")
...
thefile.write(
    ...
    str(es_hyperneat_large_ten_solved) +
    " out of " +
    str(runs) +
    " runs.\n")
...
if max_fit in es_hyperneat_large_hundred_average_fit:
    ...
    thefile.write("ES-HyperNEAT large hundred does not solve pole_balancing with best fitness: " +
                  str(es_hyperneat_large_hundred_average_fit[gens - 1]))
thefile.write(
    "\nES-HyperNEAT large hundred solves pole_balancing in " +
    str(es_hyperneat_large_hundred_solved) +
    " out of " +
    str(runs) +
    " runs.\n")
...
plt.plot(
    range(gens),
    es_hyperneat_small_one_average_fit,
    'b-.',
    label="ES-HyperNEAT small")
plt.plot(
    range(gens),
    es_hyperneat_medium_one_average_fit,
    'c-.',
    label="ES-HyperNEAT medium")
plt.plot(
    range(gens),
    es_hyperneat_large_one_average_fit,
    'm-.',
    label="ES-HyperNEAT large")
...
plt.plot(
    range(gens),
    es_hyperneat_small_ten_average_fit,
    'b-.',
    label="ES-HyperNEAT small")
plt.plot(
    range(gens),
    es_hyperneat_medium_ten_average_fit,
    'c-.',
    label="ES-HyperNEAT medium")
plt.plot(
    range(gens),
